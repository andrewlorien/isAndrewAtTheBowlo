...
const App = () => (
  <Fragment>
    ...
    <div id="howDidHe" className='tc ttc'>Built by Andrew using an <a href="https://github.com/andrewlorien/isAndrewAtTheBowlo">ambitious collection of services</a>, inspired by Dylan</div>
  </Fragment>
)
